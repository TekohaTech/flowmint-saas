...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The name of the service.', example: 'Corte de Cabello' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The price of the service.', example: 15.00 }),
